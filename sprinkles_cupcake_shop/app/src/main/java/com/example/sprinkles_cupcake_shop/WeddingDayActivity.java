...
public class WeddingDayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textWeddingAppear = findViewById(R.id.txtWeddingDay);
        buttonImage1 = findViewById(R.id.imagebWedding1);
        ...
        buttonImage2 = findViewById(R.id.imagebWedding2);
        ...
        buttonImage3 = findViewById(R.id.imagebWedding3);
        ...
        buttonImage4 = findViewById(R.id.imagebWedding4);
        ...
        buttonGo = findViewById(R.id.btnWeddingDayGo);
        ...
        buttonBack = findViewById(R.id.btnWeddingBack);
